...
test("AI panel auto-connects, shows progress, and filters image-generation events", () => {
  ...
  assert.match(panel, /openPdfReferencePicker\(\{ \.\.\.createUnifiedAiSourceConsumer\(\{ addReferencesAsTasks, setStatus \}\), trigger: sourceMenuTrigger \|\| referenceSearchButton \}\)/);
