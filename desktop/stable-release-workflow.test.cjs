...
for (const [name, transform, expected] of [
  ...
  ["mutable action", (s) => replace(s, "actions/checkout@11bd71901bbe5b1630ceea73d27597364c9af683", "actions/checkout@v4"), "verify-and-build:STEP_SCHEMA_INVALID"],
  ["shallow publish checkout", (s) => replace(s, "      - name: Freshly fetch exact publish SHA, full history, tags, and main\n        uses: actions/checkout@11bd71901bbe5b1630ceea73d27597364c9af683\n        with:\n          ref: ${{ github.sha }}\n          fetch-depth: 0", "      - name: Freshly fetch exact publish SHA, full history, tags, and main\n        uses: actions/checkout@11bd71901bbe5b1630ceea73d27597364c9af683\n        with:\n          ref: ${{ github.sha }}\n          fetch-depth: 1"), "publish-draft:STEP_SCHEMA_INVALID"],
