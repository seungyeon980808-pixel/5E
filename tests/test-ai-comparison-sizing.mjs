...
function card(width,height,ratio,generated=false){const img={naturalWidth:ratio*100,naturalHeight:100};const stage={style:{},querySelector:()=>img};return {clientWidth:width,clientHeight:height,children:[stage],querySelector:()=>stage,classList:{contains:value=>generated&&value==='ai-generated-card'},stage};}
test('comparison gives different aspect ratios equal heights without stretching',()=>{
 ...
 ()=>({paddingLeft:'0',paddingRight:'0',paddingTop:'0',paddingBottom:'0',rowGap:'0'}),{classList:{contains:()=>true}},()=>result,()=>[original],()=>1,1,{dataset:{}});
 fit(result);
