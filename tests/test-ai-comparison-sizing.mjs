...
test('comparison gives different aspect ratios equal heights without stretching',()=>{
 ...
 const fit=new Function('getComputedStyle','results','activeCandidate','sourceCards','sourceKey','activeSourceKey',sizing+'return fitCardStage;')(
 ()=>({paddingLeft:'0',paddingRight:'0',paddingTop:'0',paddingBottom:'0',rowGap:'0'}),{classList:{contains:()=>true}},()=>result,()=>[original],()=>1,1);
 fit(result);
