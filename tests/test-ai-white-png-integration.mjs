...
test("output error survives late completed terminal state",()=>{
 ...
 const ctx={currentRequestEpoch:1,serverTurnFinished:true,previewPending:false,currentImageOutputError:"invalid PNG",currentTerminalOutcome:"completed",pendingCacheOutput:{data:"bad"},currentTurnDone:false,currentTurnUsage:null,setGenerating(){},setBusy(){},setStatus:(...v)=>lastStatus=v,addTokenFooter(){}};
