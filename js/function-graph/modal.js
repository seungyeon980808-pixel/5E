...
import { renderCoordplane, renderFuncgraph } from "../render/coordplane.js?v=1.0.3";
import { makeDefaultCoordplane } from "./defaults.js?v=1.0.3";
import { sampleFunctionPoints } from "./sampler.js?v=1.0.3";
import { insertFunctionGraphs } from "./insert.js?v=1.0.3";
import { worldXFromMathX, mathXFromWorldX } from "./coords.js?v=1.0.3";
