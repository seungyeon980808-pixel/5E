...
import { renderCoordplane, renderFuncgraph } from "../render/coordplane.js?v=0.48.1";
import { makeDefaultCoordplane } from "./defaults.js?v=0.48.1";
import { sampleFunctionPoints } from "./sampler.js?v=0.48.1";
import { insertFunctionGraph } from "./insert.js?v=0.48.1";
import { worldXFromMathX, mathXFromWorldX } from "./coords.js?v=0.48.1";
