...
import { renderCoordplane, renderFuncgraph } from "../render/coordplane.js?v=0.48.7";
import { makeDefaultCoordplane } from "./defaults.js?v=0.48.7";
import { sampleFunctionPoints } from "./sampler.js?v=0.48.7";
import { insertFunctionGraph } from "./insert.js?v=0.48.7";
import { worldXFromMathX, mathXFromWorldX } from "./coords.js?v=0.48.7";
