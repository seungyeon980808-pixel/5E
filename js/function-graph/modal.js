...
import { renderCoordplane, renderFuncgraph } from "../render/coordplane.js?v=0.50.6";
import { makeDefaultCoordplane } from "./defaults.js?v=0.50.6";
import { sampleFunctionPoints } from "./sampler.js?v=0.50.6";
import { insertFunctionGraphs } from "./insert.js?v=0.50.6";
import { worldXFromMathX, mathXFromWorldX } from "./coords.js?v=0.50.6";
