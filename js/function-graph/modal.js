...
import { makeDefaultCoordplane } from "./defaults.js?v=0.54.30";
import { sampleFunctionPoints } from "./sampler.js?v=0.54.30";
import { insertFunctionGraphs } from "./insert.js?v=0.54.30";
import { worldXFromMathX, mathXFromWorldX } from "./coords.js?v=0.54.30";
