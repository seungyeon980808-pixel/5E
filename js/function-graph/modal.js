...
import { renderCoordplane, renderFuncgraph } from "../render/coordplane.js?v=0.54.10";
import { makeDefaultCoordplane } from "./defaults.js?v=0.54.10";
import { sampleFunctionPoints } from "./sampler.js?v=0.54.10";
import { insertFunctionGraphs } from "./insert.js?v=0.54.10";
import { worldXFromMathX, mathXFromWorldX } from "./coords.js?v=0.54.10";
