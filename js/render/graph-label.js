...
import { SVG_NS, HALO_RATIO, applyGlyphHalo } from "./core.js?v=1.3.0";
import { TEXT_FONT_FAMILY, EQUATION_FONT_FAMILY } from "../state.js?v=1.3.0";
import { renderFormula, measureFormula } from "../formula.js?v=1.3.0";
