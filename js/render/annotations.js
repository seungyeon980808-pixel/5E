...
} from "./core.js?v=0.54.10";
import { makeUprightLabel, estimateLabelBlock } from "./labels.js?v=0.54.10";
...
import { measureFormula, renderFormula } from "../formula.js?v=0.54.10";
import {
  DEFAULT_TEXT_FONT,
