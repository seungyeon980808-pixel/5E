...
} from "./core.js?v=0.54.11";
import { makeUprightLabel, estimateLabelBlock } from "./labels.js?v=0.54.11";
...
import { measureFormula, renderFormula } from "../formula.js?v=0.54.11";
import {
  DEFAULT_TEXT_FONT,
