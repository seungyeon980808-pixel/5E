...
import { getZoom, getRenderScale } from "../viewport.js?v=0.46.0";
import { SVG_NS, rotPt, catmullRomPath } from "./core.js?v=0.46.0";
import { renderText } from "./labels.js?v=0.46.0";
import { makeFillPattern } from "./fill.js?v=0.46.0";
import {
  renderRect,
  renderEllipse,
  renderTriangle,
...
import { DEFAULT_TEXT_SIZE_MM } from "../state.js?v=0.46.0";
import { resolveObjectStyle } from "../style-mode.js?v=0.46.0";
import { renderFormula } from "../formula.js?v=0.46.0";
import { IMAGE_EDIT_SESSION_ID } from "../image-cutout.js?v=0.46.0";
