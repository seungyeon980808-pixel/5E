...
import { getZoom, getRenderScale } from "../viewport.js?v=1.0.3";
import { SVG_NS, rotPt, catmullRomPath } from "./core.js?v=1.0.3";
import { renderText } from "./labels.js?v=1.0.3";
import { makeFillPattern } from "./fill.js?v=1.0.3";
import {
  renderRect,
  renderEllipse,
  renderTriangle,
  ...
  renderImage,
  renderSvgAsset,
} from "./shapes.js?v=1.0.3";
import { renderAxes, renderAngleArc, renderRightAngle, renderLabeler } from "./annotations.js?v=1.0.3";
import { renderCoordplane, renderFuncgraph } from "./coordplane.js?v=1.0.3";
import { renderCircuit } from "./circuit.js?v=1.0.3";
import { renderOptics, renderApparatus } from "./optics-apparatus.js?v=1.0.3";
import { renderPendulum, pendulumBBox } from "./pendulum.js?v=1.0.3";
import { renderGauge } from "./gauge.js?v=1.0.3";
import { DEFAULT_TEXT_SIZE_MM } from "../state.js?v=1.0.3";
import { SIZE_TYPES, TEXT_MEASURED_TYPES, POINT_ARRAY_TYPES } from "../object-types.js?v=1.0.3";
import { resolveObjectStyle } from "../style-mode.js?v=1.0.3";
import { renderFormula } from "../formula.js?v=1.0.3";
import { IMAGE_EDIT_SESSION_ID } from "../image-cutout.js?v=1.0.3";
