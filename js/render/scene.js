...
import { SVG_NS, rotPt, catmullRomPath } from "./core.js?v=1.2.0";
import { renderText } from "./labels.js?v=1.2.0";
import { makeFillPattern } from "./fill.js?v=1.2.0";
import {
  renderRect,
  renderEllipse,
  renderTriangle,
  ...
  renderImage,
  renderSvgAsset,
} from "./shapes.js?v=1.2.0";
import { renderAxes, renderAngleArc, renderRightAngle, renderLabeler } from "./annotations.js?v=1.2.0";
import { renderCoordplane, renderFuncgraph } from "./coordplane.js?v=1.2.0";
