...
import { getZoom, getRenderScale } from "../viewport.js?v=0.48.6";
import { SVG_NS, rotPt, catmullRomPath } from "./core.js?v=0.48.6";
import { renderText } from "./labels.js?v=0.48.6";
import { makeFillPattern } from "./fill.js?v=0.48.6";
import {
  renderRect,
  renderEllipse,
  renderTriangle,
  ...
  renderImage,
  renderSvgAsset,
} from "./shapes.js?v=0.48.6";
import { renderAxes, renderAngleArc, renderRightAngle, renderLabeler } from "./annotations.js?v=0.48.6";
import { renderCoordplane, renderFuncgraph } from "./coordplane.js?v=0.48.6";
import { renderCircuit } from "./circuit.js?v=0.48.6";
import { renderOptics, renderApparatus } from "./optics-apparatus.js?v=0.48.6";
import { renderPendulum, pendulumBBox } from "./pendulum.js?v=0.48.6";
import { DEFAULT_TEXT_SIZE_MM } from "../state.js?v=0.48.6";
import { resolveObjectStyle } from "../style-mode.js?v=0.48.6";
import { renderFormula } from "../formula.js?v=0.48.6";
import { IMAGE_EDIT_SESSION_ID } from "../image-cutout.js?v=0.48.6";
