...
import { getZoom, getRenderScale } from "../viewport.js?v=0.44.3";
import { SVG_NS, rotPt, catmullRomPath } from "./core.js?v=0.44.3";
import { renderText } from "./labels.js?v=0.44.3";
import { makeFillPattern } from "./fill.js?v=0.44.3";
import {
  renderRect,
  renderEllipse,
  renderTriangle,
  ...
  renderImage,
  renderSvgAsset,
} from "./shapes.js?v=0.44.3";
import { renderAxes, renderAngleArc, renderRightAngle, renderLabeler } from "./annotations.js?v=0.44.3";
import { renderCircuit } from "./circuit.js?v=0.44.3";
import { renderOptics, renderApparatus } from "./optics-apparatus.js?v=0.44.3";
import { renderPendulum, pendulumBBox } from "./pendulum.js?v=0.44.3";
import { DEFAULT_TEXT_SIZE_MM } from "../state.js?v=0.44.3";
import { resolveObjectStyle } from "../style-mode.js?v=0.44.3";
import { renderFormula } from "../formula.js?v=0.44.3";
import { IMAGE_EDIT_SESSION_ID } from "../image-cutout.js?v=0.44.3";
