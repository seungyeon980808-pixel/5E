...
import { getZoom, getRenderScale } from "../viewport.js?v=0.51.1";
import { SVG_NS, rotPt, catmullRomPath } from "./core.js?v=0.51.1";
import { renderText } from "./labels.js?v=0.51.1";
import { makeFillPattern } from "./fill.js?v=0.51.1";
import {
  renderRect,
  renderEllipse,
  renderTriangle,
  ...
  renderImage,
  renderSvgAsset,
} from "./shapes.js?v=0.51.1";
import { renderAxes, renderAngleArc, renderRightAngle, renderLabeler } from "./annotations.js?v=0.51.1";
import { renderCoordplane, renderFuncgraph } from "./coordplane.js?v=0.51.1";
import { renderCircuit } from "./circuit.js?v=0.51.1";
import { renderOptics, renderApparatus } from "./optics-apparatus.js?v=0.51.1";
import { renderPendulum, pendulumBBox } from "./pendulum.js?v=0.51.1";
import { DEFAULT_TEXT_SIZE_MM } from "../state.js?v=0.51.1";
import { SIZE_TYPES, TEXT_MEASURED_TYPES, POINT_ARRAY_TYPES } from "../object-types.js?v=0.51.1";
import { resolveObjectStyle } from "../style-mode.js?v=0.51.1";
import { renderFormula } from "../formula.js?v=0.51.1";
import { IMAGE_EDIT_SESSION_ID } from "../image-cutout.js?v=0.51.1";
