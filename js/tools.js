...
// FREE-DRAW TOOL (F) extracted to tools/free-draw.js (setupFreeDraw).

// NODE (점) single-click placement extracted to tools/node-placement.js
// (setupNodePlacement). It reads the armed optics-kind via getOpticsKind() below.
