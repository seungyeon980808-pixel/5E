...
import { DEFAULT_TEXT_FONT, DEFAULT_TEXT_SIZE_MM, mmToPt } from "./state.js?v=1.3.0";
...
import { buildTextSection } from "./inspector/section-text.js?v=1.3.0";
import { buildFillSection } from "./inspector/section-fill.js?v=1.3.0";
import { buildGeometrySection } from "./inspector/section-geometry.js?v=1.3.0";
import { buildProtectSection } from "./inspector/section-protect.js?v=1.3.0";
...
import { buildArtboardSection } from "./inspector/section-artboard.js?v=1.3.0";
import { buildLayersSection } from "./inspector/section-layers.js?v=1.3.0";
import { buildGlobalImageSection } from "./inspector/section-global-image.js?v=1.3.0";
