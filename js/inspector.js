...
import { DEFAULT_TEXT_FONT, DEFAULT_TEXT_SIZE_MM, mmToPt } from "./state.js?v=0.48.7";
import { resolveObjectStyle } from "./style-mode.js?v=0.48.7";
import {
  SHAPE_TYPES, LINE_TYPES, CIRCUIT_HEIGHT_ELEMENTS, supportsDash, isColorDragging,
} from "./inspector/widgets.js?v=0.48.7";
import { createInspectorContext } from "./inspector/context.js?v=0.48.7";
import { buildLineSection } from "./inspector/section-line.js?v=0.48.7";
import { buildGroupSection } from "./inspector/section-group.js?v=0.48.7";
import { buildTextSection } from "./inspector/section-text.js?v=0.48.7";
import { buildFillSection } from "./inspector/section-fill.js?v=0.48.7";
import { buildGeometrySection } from "./inspector/section-geometry.js?v=0.48.7";
import { buildProtectSection } from "./inspector/section-protect.js?v=0.48.7";
import { buildImageSection } from "./inspector/section-image.js?v=0.48.7";
import { buildPendulumSection } from "./inspector/section-pendulum.js?v=0.48.7";
import { buildCoordplaneSection } from "./inspector/section-coordplane.js?v=0.48.7";
import { buildFuncgraphSection } from "./inspector/section-funcgraph.js?v=0.48.7";
import { buildArtboardSection } from "./inspector/section-artboard.js?v=0.48.7";
import { buildLayersSection } from "./inspector/section-layers.js?v=0.48.7";
import { buildGlobalImageSection } from "./inspector/section-global-image.js?v=0.48.7";
