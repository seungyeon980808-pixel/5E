...
import { insertImageFromSrc } from "./image-paste.js?v=1.3.0";
import { openObjectifyWithFile } from "./image-objectify.js?v=1.3.0";

import { openReferenceWindow } from "./reference-window.js?v=1.3.0";
import { setOpenOrigin } from "./modal-motion.js?v=1.3.0";
