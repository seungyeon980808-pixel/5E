...
import { render } from "./render.js?v=0.54.11";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.54.11";
import { initTools } from "./tools.js?v=0.54.11";
import { initCutTool } from "./cut-tool.js?v=0.54.11";
import { initTransform, undo, redo } from "./transform.js?v=0.54.11";
import { initInspector } from "./inspector.js?v=0.54.11";
import { initProjectIO } from "./project-io.js?v=0.54.11";
import { initExportDialog } from "./export-dialog.js?v=0.54.11";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.54.11";
import { initSettings } from "./settings.js?v=0.54.11";
import { initImageObjectify } from "./image-objectify.js?v=0.54.11";
import { initImagePaste } from "./image-paste.js?v=0.54.11";
import { initImageCutout } from "./image-cutout.js?v=0.54.11";
import { initExamLibrary } from "./exam-library.js?v=0.54.11";
import { initTemplates } from "./templates.js?v=0.54.11";
import { initObjectSearch } from "./search.js?v=0.54.11";
import { initSubjectObjects } from "./subject-objects.js?v=0.54.11";
import { initToolHint } from "./tool-hint.js?v=0.54.11";
import { initPersonalObjects } from "./personal-objects.js?v=0.54.11";
import { initBulkEdit } from "./bulk-edit.js?v=0.54.11";
import { initGaugeSection } from "./inspector/section-gauge.js?v=0.54.11";
