...
import { render } from "./render.js?v=0.54.51";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.54.51";
import { initTools } from "./tools.js?v=0.54.51";
import { initCutTool } from "./cut-tool.js?v=0.54.51";
import { initTransform, undo, redo } from "./transform.js?v=0.54.51";
import { initInspector } from "./inspector.js?v=0.54.51";
import { initProjectIO } from "./project-io.js?v=0.54.51";
import { initExportDialog } from "./export-dialog.js?v=0.54.51";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.54.51";
import { initSettings } from "./settings.js?v=0.54.51";
import { initImageObjectify } from "./image-objectify.js?v=0.54.51";
import { initImagePaste } from "./image-paste.js?v=0.54.51";
import { initImageCutout } from "./image-cutout.js?v=0.54.51";
import { initExamLibrary } from "./exam-library.js?v=0.54.51";
import { initTemplates } from "./templates.js?v=0.54.51";
import { initObjectSearch } from "./search.js?v=0.54.51";
import { initCommandPalette } from "./command-palette.js?v=0.54.51";
import { initSubjectObjects } from "./subject-objects.js?v=0.54.51";
import { initToolHint } from "./tool-hint.js?v=0.54.51";
import { initPersonalObjects } from "./personal-objects.js?v=0.54.51";
import { initBulkEdit } from "./bulk-edit.js?v=0.54.51";
import { initDataPlot } from "./data-plot.js?v=0.54.51";
import { initGaugeSection } from "./inspector/section-gauge.js?v=0.54.51";
import { initAutosave } from "./autosave.js?v=0.54.51";
import { initPages } from "./pages.js?v=0.54.51";
