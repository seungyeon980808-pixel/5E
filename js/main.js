...
import { render } from "./render.js?v=1.0.3";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=1.0.3";
import { initTools } from "./tools.js?v=1.0.3";
import { initCutTool } from "./cut-tool.js?v=1.0.3";
import { initTransform, undo, redo } from "./transform.js?v=1.0.3";
import { initInspector } from "./inspector.js?v=1.0.3";
import { initProjectIO } from "./project-io.js?v=1.0.3";
import { initExportDialog } from "./export-dialog.js?v=1.0.3";
import { initRuler, setRulerVisible } from "./ruler.js?v=1.0.3";
import { initSettings } from "./settings.js?v=1.0.3";
import { initImageObjectify } from "./image-objectify.js?v=1.0.3";
import { initImagePaste } from "./image-paste.js?v=1.0.3";
import { initImageCutout } from "./image-cutout.js?v=1.0.3";
import { initExamLibrary } from "./exam-library.js?v=1.0.3";
import { initTemplates } from "./templates.js?v=1.0.3";
import { initObjectSearch } from "./search.js?v=1.0.3";
import { initCommandPalette } from "./command-palette.js?v=1.0.3";
import { initSubjectObjects } from "./subject-objects.js?v=1.0.3";
import { initToolHint } from "./tool-hint.js?v=1.0.3";
import { initTooltips } from "./tooltip.js?v=1.0.3";
import { initViewMode } from "./view-mode.js?v=1.0.3";
import { initPersonalObjects } from "./personal-objects.js?v=1.0.3";
import { initBulkEdit } from "./bulk-edit.js?v=1.0.3";
import { initDataPlot } from "./data-plot.js?v=1.0.3";
import { initGaugeSection } from "./inspector/section-gauge.js?v=1.0.3";
import { initAutosave } from "./autosave.js?v=1.0.3";
import { initPages } from "./pages.js?v=1.0.3";
