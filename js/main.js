...
import { render } from "./render.js?v=1.0.1";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=1.0.1";
import { initTools } from "./tools.js?v=1.0.1";
import { initCutTool } from "./cut-tool.js?v=1.0.1";
import { initTransform, undo, redo } from "./transform.js?v=1.0.1";
import { initInspector } from "./inspector.js?v=1.0.1";
import { initProjectIO } from "./project-io.js?v=1.0.1";
import { initExportDialog } from "./export-dialog.js?v=1.0.1";
import { initRuler, setRulerVisible } from "./ruler.js?v=1.0.1";
import { initSettings } from "./settings.js?v=1.0.1";
import { initImageObjectify } from "./image-objectify.js?v=1.0.1";
import { initImagePaste } from "./image-paste.js?v=1.0.1";
import { initImageCutout } from "./image-cutout.js?v=1.0.1";
import { initExamLibrary } from "./exam-library.js?v=1.0.1";
import { initTemplates } from "./templates.js?v=1.0.1";
import { initObjectSearch } from "./search.js?v=1.0.1";
import { initCommandPalette } from "./command-palette.js?v=1.0.1";
import { initSubjectObjects } from "./subject-objects.js?v=1.0.1";
import { initToolHint } from "./tool-hint.js?v=1.0.1";
import { initTooltips } from "./tooltip.js?v=1.0.1";
import { initViewMode } from "./view-mode.js?v=1.0.1";
import { initPersonalObjects } from "./personal-objects.js?v=1.0.1";
import { initBulkEdit } from "./bulk-edit.js?v=1.0.1";
import { initDataPlot } from "./data-plot.js?v=1.0.1";
import { initGaugeSection } from "./inspector/section-gauge.js?v=1.0.1";
import { initAutosave } from "./autosave.js?v=1.0.1";
import { initPages } from "./pages.js?v=1.0.1";
