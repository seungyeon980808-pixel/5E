...
import { initTemplates } from "./templates.js?v=0.36.0";
import { initObjectSearch } from "./search.js?v=0.36.0";
...
console.info(
  "[시범공개] [5E v0.36.0] Pick R (or press R), drag on the canvas to draw a\n" +
