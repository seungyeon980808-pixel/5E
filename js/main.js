...
import { state } from "./state.js?v=0.54.12";
import { render } from "./render.js?v=0.54.12";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.54.12";
import { initTools } from "./tools.js?v=0.54.12";
import { initCutTool } from "./cut-tool.js?v=0.54.12";
import { initTransform, undo, redo } from "./transform.js?v=0.54.12";
import { initInspector } from "./inspector.js?v=0.54.12";
import { initProjectIO } from "./project-io.js?v=0.54.12";
import { initExportDialog } from "./export-dialog.js?v=0.54.12";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.54.12";
import { initSettings } from "./settings.js?v=0.54.12";
import { initImageObjectify } from "./image-objectify.js?v=0.54.12";
import { initImagePaste } from "./image-paste.js?v=0.54.12";
import { initImageCutout } from "./image-cutout.js?v=0.54.12";
import { initExamLibrary } from "./exam-library.js?v=0.54.12";
import { initTemplates } from "./templates.js?v=0.54.12";
import { initObjectSearch } from "./search.js?v=0.54.12";
import { initSubjectObjects } from "./subject-objects.js?v=0.54.12";
import { initToolHint } from "./tool-hint.js?v=0.54.12";
import { initPersonalObjects } from "./personal-objects.js?v=0.54.12";
import { initBulkEdit } from "./bulk-edit.js?v=0.54.12";
import { initGaugeSection } from "./inspector/section-gauge.js?v=0.54.12";
