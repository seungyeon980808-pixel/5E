...
import { state } from "./state.js?v=0.50.9";
import { render } from "./render.js?v=0.50.9";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.50.9";
import { initTools } from "./tools.js?v=0.50.9";
import { initCutTool } from "./cut-tool.js?v=0.50.9";
import { initTransform, undo, redo } from "./transform.js?v=0.50.9";
import { initInspector } from "./inspector.js?v=0.50.9";
import { initProjectIO } from "./project-io.js?v=0.50.9";
import { initExportDialog } from "./export-dialog.js?v=0.50.9";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.50.9";
import { initSettings } from "./settings.js?v=0.50.9";
import { initImageObjectify } from "./image-objectify.js?v=0.50.9";
import { initImageImportMock } from "./image-import-mock.js?v=0.50.9";
import { initImagePaste } from "./image-paste.js?v=0.50.9";
import { initImageCutout } from "./image-cutout.js?v=0.50.9";
import { initTemplates } from "./templates.js?v=0.50.9";
import { initObjectSearch } from "./search.js?v=0.50.9";
...
if (_APP_DEBUG_ENABLED) {
  ...
  console.info(
    "[시범공개] [5E v0.50.9] Press S (or click the toolbar button) to arm the\n" +
