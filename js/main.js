...
import { render } from "./render.js?v=0.54.30";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.54.30";
import { initTools } from "./tools.js?v=0.54.30";
import { initCutTool } from "./cut-tool.js?v=0.54.30";
import { initTransform, undo, redo } from "./transform.js?v=0.54.30";
import { initInspector } from "./inspector.js?v=0.54.30";
import { initProjectIO } from "./project-io.js?v=0.54.30";
import { initExportDialog } from "./export-dialog.js?v=0.54.30";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.54.30";
import { initSettings } from "./settings.js?v=0.54.30";
import { initImageObjectify } from "./image-objectify.js?v=0.54.30";
import { initImagePaste } from "./image-paste.js?v=0.54.30";
import { initImageCutout } from "./image-cutout.js?v=0.54.30";
import { initExamLibrary } from "./exam-library.js?v=0.54.30";
import { initTemplates } from "./templates.js?v=0.54.30";
import { initObjectSearch } from "./search.js?v=0.54.30";
import { initCommandPalette } from "./command-palette.js?v=0.54.30";
import { initSubjectObjects } from "./subject-objects.js?v=0.54.30";
import { initToolHint } from "./tool-hint.js?v=0.54.30";
import { initPersonalObjects } from "./personal-objects.js?v=0.54.30";
import { initBulkEdit } from "./bulk-edit.js?v=0.54.30";
import { initDataPlot } from "./data-plot.js?v=0.54.30";
import { initGaugeSection } from "./inspector/section-gauge.js?v=0.54.30";
import { initAutosave } from "./autosave.js?v=0.54.30";
import { initPages } from "./pages.js?v=0.54.30";
