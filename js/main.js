...
import { render } from "./render.js?v=0.18.0";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.18.0";
import { initTools } from "./tools.js?v=0.18.0";
import { initTransform, undo, redo } from "./transform.js?v=0.18.0";
import { initInspector } from "./inspector.js?v=0.18.0";
import { initProjectIO } from "./project-io.js?v=0.18.0";
import { initExportDialog } from "./export-dialog.js?v=0.18.0";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.18.0";
import { initSettings } from "./settings.js?v=0.18.0";
import { initImageObjectify } from "./image-objectify.js?v=0.18.0";
import { initTemplates } from "./templates.js?v=0.18.0";
import { initObjectSearch } from "./search.js?v=0.18.0";
...
console.info(
  "[5E v0.18.0] Pick R (or press R), drag on the canvas to draw a\n" +
