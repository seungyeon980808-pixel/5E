...
import { render } from "./render.js?v=0.16.1";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.16.1";
import { initTools } from "./tools.js?v=0.16.1";
import { initTransform, undo, redo } from "./transform.js?v=0.16.1";
import { initInspector } from "./inspector.js?v=0.16.1";
import { initProjectIO } from "./project-io.js?v=0.16.1";
import { initExportDialog } from "./export-dialog.js?v=0.16.1";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.16.1";
import { initSettings } from "./settings.js?v=0.16.1";
import { initImageObjectify } from "./image-objectify.js?v=0.16.1";
import { initTemplates } from "./templates.js?v=0.16.1";
import { initObjectSearch } from "./search.js?v=0.16.1";
...
console.info(
  "[PhysicsExamDrawer v0.16.1] Pick R (or press R), drag on the canvas to draw a\n" +
