...
import { render } from "./render.js?v=0.56.0";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.56.0";
import { initTools } from "./tools.js?v=0.56.0";
import { initCutTool } from "./cut-tool.js?v=0.56.0";
import { initTransform, undo, redo } from "./transform.js?v=0.56.0";
import { initInspector } from "./inspector.js?v=0.56.0";
import { initProjectIO } from "./project-io.js?v=0.56.0";
import { initExportDialog } from "./export-dialog.js?v=0.56.0";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.56.0";
import { initSettings } from "./settings.js?v=0.56.0";
import { initImageObjectify } from "./image-objectify.js?v=0.56.0";
import { initImagePaste } from "./image-paste.js?v=0.56.0";
import { initImageCutout } from "./image-cutout.js?v=0.56.0";
import { initExamLibrary } from "./exam-library.js?v=0.56.0";
import { initTemplates } from "./templates.js?v=0.56.0";
import { initObjectSearch } from "./search.js?v=0.56.0";
...
import { initGaugeSection } from "./inspector/section-gauge.js?v=0.56.0";
import { initAutosave } from "./autosave.js?v=0.56.0";
import { initPages } from "./pages.js?v=0.56.0";
