...
import { initCutTool } from "./cut-tool.js?v=1.6.0-rc.1";
...
import { initSettings } from "./settings.js?v=1.6.0-rc.1-settings-health";
...
import { initAiPanel } from "./ai-panel.js?v=1.5.27-phase5-finalization-proof";
...
if (_APP_DEBUG_ENABLED) {
  ...
  console.info(
    "[시범공개] [5E v1.6.0-rc.1] Press S (or click the toolbar button) to arm the\n" +
