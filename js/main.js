...
import { render } from "./render.js?v=0.48.3";
import { initViewport, getZoom, screenToWorld, centerView, setCenterLocked } from "./viewport.js?v=0.48.3";
import { initTools } from "./tools.js?v=0.48.3";
import { initCutTool } from "./cut-tool.js?v=0.48.3";
import { initTransform, undo, redo } from "./transform.js?v=0.48.3";
import { initInspector } from "./inspector.js?v=0.48.3";
import { initProjectIO } from "./project-io.js?v=0.48.3";
import { initExportDialog } from "./export-dialog.js?v=0.48.3";
import { initRuler, setRulerVisible } from "./ruler.js?v=0.48.3";
import { initSettings } from "./settings.js?v=0.48.3";
import { initImageObjectify } from "./image-objectify.js?v=0.48.3";
import { initImageImportMock } from "./image-import-mock.js?v=0.48.3";
import { initImagePaste } from "./image-paste.js?v=0.48.3";
import { initImageCutout } from "./image-cutout.js?v=0.48.3";
import { initTemplates } from "./templates.js?v=0.48.3";
import { initObjectSearch } from "./search.js?v=0.48.3";
...
if (_APP_DEBUG_ENABLED) {
  ...
  console.info(
    "[시범공개] [5E v0.48.3] Press S (or click the toolbar button) to arm the\n" +
