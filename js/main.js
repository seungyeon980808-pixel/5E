...
import { render } from "./render.js?v=0.9.1";
import { initViewport, getZoom, screenToWorld } from "./viewport.js?v=0.9.1";
import { initTools } from "./tools.js?v=0.9.1";
import { initTransform } from "./transform.js?v=0.9.1";
import { initInspector } from "./inspector.js?v=0.9.1";
...
console.info(
  "[PhysicsExamDrawer v0.9.1] Pick R (or press R), drag on the canvas to draw a\n" +
