...
import { worldFromMath } from "./function-graph/coords.js?v=1.1.0";
...
function buildModal() {
  ...
  overlay.innerHTML = `
    <div class="modal" role="dialog" aria-modal="true" aria-label="데이터 표" style="width:560px;max-width:96vw;">
      ...
      <p style="color:var(--text-secondary);font-size: calc(12px * var(--text-scale, 1));line-height:1.7;margin:0 0 8px;">
...
3	6.2"
      ...
      <div style="display:flex;align-items:center;gap:16px;margin-top:10px;font-size: calc(13px * var(--text-scale, 1));color:var(--text-secondary);">
        <label style="display:flex;align-items:center;gap:6px;cursor:pointer;">
          <input type="checkbox" id="dp-connect" /> 측정점을 연결선(꺾은선)으로 잇기
        </label>
      </div>
      <div id="dp-error" style="color:#e5534b;font-size: calc(12px * var(--text-scale, 1));min-height:16px;margin-top:6px;"></div>
      <div style="color:var(--text-secondary);font-size: calc(12px * var(--text-scale, 1));line-height:1.7;margin-top:2px;">
