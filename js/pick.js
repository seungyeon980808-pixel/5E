...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.27";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.27";
import { measureFormula } from "./formula.js?v=0.54.27";
import {
...
} from "./object-types.js?v=0.54.27";
