...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.8";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.8";
import { measureFormula } from "./formula.js?v=0.54.8";
import {
