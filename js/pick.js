...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.0";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.0";
import { measureFormula } from "./formula.js?v=0.54.0";
import {
