...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.2";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.2";
import { measureFormula } from "./formula.js?v=0.54.2";
import {
