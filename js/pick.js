...
import { DEFAULT_TEXT_FONT, DEFAULT_TEXT_SIZE_MM, scaleBBoxForWidth } from "./state.js?v=1.3.0";
...
import { estimateLabelBlock } from "./render/labels.js?v=1.3.0";
import { measureFormula } from "./formula.js?v=1.3.0";
import {
