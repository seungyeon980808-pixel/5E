...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.30";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.30";
import { measureFormula } from "./formula.js?v=0.54.30";
import {
...
} from "./object-types.js?v=0.54.30";
