...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.12";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.12";
import { measureFormula } from "./formula.js?v=0.54.12";
import {
...
} from "./object-types.js?v=0.54.12";
