...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=1.0.4";
...
import { estimateLabelBlock } from "./render/labels.js?v=1.0.4";
import { measureFormula } from "./formula.js?v=1.0.4";
import {
