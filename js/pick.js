...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.11";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.11";
import { measureFormula } from "./formula.js?v=0.54.11";
import {
...
} from "./object-types.js?v=0.54.11";
