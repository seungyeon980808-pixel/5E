...
import { circuitBodyPolygon, pendulumGeometry, pendulumBBox } from "./render.js?v=0.54.14";
...
import { estimateLabelBlock } from "./render/labels.js?v=0.54.14";
import { measureFormula } from "./formula.js?v=0.54.14";
import {
...
} from "./object-types.js?v=0.54.14";
