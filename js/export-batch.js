...
import { rasterizeExportCanvas } from "./svg-export.js?v=1.3.0";
import { commitActivePage } from "./pages.js?v=1.3.0";
import { showAlert } from "./ui-dialogs.js?v=1.3.0";
import { idbAvailable, idbGet, idbSet } from "./idb-store.js?v=1.3.0";
