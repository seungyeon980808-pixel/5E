...
import { screenToWorld, getRenderScale } from "../viewport.js?v=1.3.0";
import { snapAngle, mathAngleDeg, snappedDeg, normalizeSweep } from "../geometry.js?v=1.3.0";
import { setSnapPreview } from "../render.js?v=1.3.0";
import { resolveEndpointSnap } from "../snap.js?v=1.3.0";
import { applyNewObjectStyleDefaults } from "../style-mode.js?v=1.3.0";
import { DEFAULT_TEXT_FONT, DEFAULT_TEXT_SIZE_MM } from "../state.js?v=1.3.0";
import { nextObjectId } from "./id.js?v=1.3.0";
import { openLabelerTextEditor } from "../text-editor.js?v=1.3.0";
import { mathFromWorld, worldFromMath } from "../function-graph/coords.js?v=1.3.0";
