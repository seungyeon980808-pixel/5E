...
import { screenToWorld, getRenderScale } from "../viewport.js?v=0.54.8";
import { snapAngle, mathAngleDeg, snappedDeg, normalizeSweep } from "../geometry.js?v=0.54.8";
import { setSnapPreview } from "../render.js?v=0.54.8";
import { resolveEndpointSnap } from "../snap.js?v=0.54.8";
import { applyNewObjectStyleDefaults } from "../style-mode.js?v=0.54.8";
import { DEFAULT_TEXT_FONT, DEFAULT_TEXT_SIZE_MM } from "../state.js?v=0.54.8";
import { nextObjectId } from "./id.js?v=0.54.8";
import { openLabelerTextEditor } from "../text-editor.js?v=0.54.8";
import {
  isSpaceHeld,
  makeLine, makeCircuit, makePolyline, makeCurve, isCommittable,
  DEFAULT_STROKE_WIDTH, MIN_SIZE,
} from "../tools.js?v=0.54.8";
