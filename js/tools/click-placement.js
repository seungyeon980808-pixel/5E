...
import { snapAngle, mathAngleDeg, snappedDeg, normalizeSweep } from "../geometry.js?v=1.0.2";
import { setSnapPreview } from "../render.js?v=1.0.2";
...
import { nextObjectId } from "./id.js?v=1.0.2";
