...
import { armSymbol } from "./tools.js?v=0.50.0";
import { renderObject } from "./render.js?v=0.50.0";
import { applyNewObjectStyleDefaults } from "./style-mode.js?v=0.50.0";
import { getSvgAsset } from "./svg-assets.js?v=0.50.0";
import { makeDefaultCoordplane } from "./function-graph/defaults.js?v=0.50.0";
import { openFunctionModal } from "./function-graph/modal.js?v=0.50.0";
