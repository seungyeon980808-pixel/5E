...
import { exportPng, exportSvg, formatExportTimestamp } from "./svg-export.js?v=0.53.0";
import { registerTopMenu } from "./top-menu.js?v=0.53.0";
import { screenToWorld } from "./viewport.js?v=0.53.0";
import { openExamPreview } from "./exam-preview.js?v=0.53.0";
