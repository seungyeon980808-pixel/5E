...
import { exportPng, exportSvg, copyPngToClipboard, formatExportTimestamp } from "./svg-export.js?v=0.54.11";
import { showAlert } from "./ui-dialogs.js?v=0.54.11";
import { registerTopMenu } from "./top-menu.js?v=0.54.11";
import { screenToWorld } from "./viewport.js?v=0.54.11";
import { openExamPreview } from "./exam-preview.js?v=0.54.11";
