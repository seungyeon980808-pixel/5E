...
import { exportPng, exportSvg, copyPngToClipboard, formatExportTimestamp, rasterizeExportCanvas } from "./svg-export.js?v=1.0.2";
import { commitActivePage } from "./pages.js?v=1.0.2";
...
import { openExamPreview } from "./exam-preview.js?v=1.0.2";
