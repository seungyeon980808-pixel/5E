...
import { exportPng, exportSvg, formatExportTimestamp } from "./svg-export.js?v=0.54.6";
import { registerTopMenu } from "./top-menu.js?v=0.54.6";
import { screenToWorld } from "./viewport.js?v=0.54.6";
import { openExamPreview } from "./exam-preview.js?v=0.54.6";
