...
import { exportPng, exportSvg, copyPngToClipboard, formatExportTimestamp } from "./svg-export.js?v=1.2.0";
import { openBatchExport } from "./export-batch.js?v=1.2.0";
...
import { openExamPreview } from "./exam-preview.js?v=1.2.0";
