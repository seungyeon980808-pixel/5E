  ...
  steps: [
    ...
    },
    {
      ...
      text:
        ...
        "· 영역을 끈 다음에는 크기 표시 옆 [내보내기] 를 누르면 확정됩니다\n" +
        "· 영역을 안 정하면 아트보드 전체가 나갑니다\n" +
        "· '페이지 선택…'을 쓰면 문항별 페이지를 그 폴더로 한 번에 뽑습니다",
...
const ADVANCED_SHAPES = {
  ...
  steps: [
    ...
    { chapter:"통일 수정", target:()=>[bulkRow(2)||"#bulk-gap-rows","#bulk-apply"], title:"직선 사이의 간격을 맞춰 주세요", text:"이번에는 ‘좌우 간격 통일’을 적용합니다. 정렬과 간격은 서로 다른 기능입니다.", wait:{until:()=>advancedLineGapsAreEven(),hint:"좌우 간격 통일을 적용해 주세요"} },
