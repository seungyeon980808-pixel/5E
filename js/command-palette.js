...
import { TEMPLATES, activateTemplate, buildSymbolIcon, sizeIconViewBox } from "./templates.js?v=1.1.0";
import { listPersonalItems, insertPersonalItem } from "./personal-objects.js?v=1.1.0";
