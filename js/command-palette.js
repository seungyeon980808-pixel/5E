...
import { TEMPLATES, activateTemplate, buildSymbolIcon, sizeIconViewBox } from "./templates.js?v=1.2.0";
import { listPersonalItems, insertPersonalItem } from "./personal-objects.js?v=1.2.0";
