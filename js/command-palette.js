...
import { TEMPLATES, activateTemplate, buildSymbolIcon, sizeIconViewBox } from "./templates.js?v=0.55.0";
import { listPersonalItems, insertPersonalItem } from "./personal-objects.js?v=0.55.0";
