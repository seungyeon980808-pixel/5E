...
import { TEMPLATES, activateTemplate, buildSymbolIcon, sizeIconViewBox } from "./templates.js?v=0.54.14";
import { listPersonalItems, insertPersonalItem } from "./personal-objects.js?v=0.54.14";
