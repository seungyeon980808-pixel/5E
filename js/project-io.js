...
import { rebuildGroups } from "./transform.js?v=0.16.4";
import { screenToWorld } from "./viewport.js?v=0.16.4";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.16.4";
