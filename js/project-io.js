...
import { rebuildGroups } from "./transform.js?v=0.17.2";
import { screenToWorld } from "./viewport.js?v=0.17.2";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.17.2";
