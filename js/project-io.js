...
import { rebuildGroups } from "./transform.js?v=0.50.5";
import { screenToWorld } from "./viewport.js?v=0.50.5";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.50.5";
import { DEFAULT_TEXT_SIZE_MM, DEFAULT_TEXT_FONT, normalizeTextRuns, textRunsToText } from "./state.js?v=0.50.5";
