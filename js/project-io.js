...
import { rebuildGroups } from "./transform.js?v=0.44.0";
import { screenToWorld } from "./viewport.js?v=0.44.0";
import { applyNewObjectStyleDefaults, migrateObjectStyleMode } from "./style-mode.js?v=0.44.0";
import { DEFAULT_TEXT_SIZE_MM, DEFAULT_TEXT_FONT, normalizeTextRuns, textRunsToText } from "./state.js?v=0.44.0";
