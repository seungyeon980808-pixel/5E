...
import { nativeProjectTarget, saveNativeProjectPackage, initProjectLaunch } from './project-launch.js?v=1';
import { extractWindowsProjectSource } from './windows-project-source.mjs?v=1';
