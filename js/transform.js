...
import { resolveSnap, resolveEndpointSnap, resolveRadialCenterSnap } from "./snap.js?v=0.54.6";
import { setSnapPreview, pendulumBBox } from "./render.js?v=0.54.6";
import { pickSelectableObjectFromEvent } from "./tools.js?v=0.54.6";
import { IMAGE_EDIT_SESSION_ID } from "./image-cutout.js?v=0.54.6";
import { SHAPE_TYPES, SIZE_TYPES, FLIP_TYPES } from "./object-types.js?v=0.54.6";
