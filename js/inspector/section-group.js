...
export function buildGroupSection(ctx) {
  ...
  ungroupBtn.style.cssText = "padding:4px 10px;font-size: calc(11px * var(--text-scale, 1));cursor:pointer;border:1px solid var(--border);border-radius:6px;background:var(--bg-input);color:var(--text-primary);width:100%;";
  ...
  groupBtn.style.cssText = "padding:4px 10px;font-size: calc(11px * var(--text-scale, 1));cursor:pointer;border:1px solid var(--border);border-radius:6px;background:var(--bg-input);color:var(--text-primary);width:100%;";
