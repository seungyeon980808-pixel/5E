...
import { makeColorPicker, makeSection, supportsDash, DASH_PRESETS } from "./widgets.js?v=1.1.0";
...
export function buildLineSection(ctx) {
  ...
  widthNum.max = "0.5";
  widthNum.step = "0.1";
  widthNum.style.cssText = "width:40px;font-size: calc(11px * var(--text-scale, 1));border:1px solid var(--border);border-radius:6px;padding:2px 4px;text-align:center;background:var(--bg-input);color:var(--text-primary);";
  ...
  dimensionLabelInp.style.cssText = "width:90px;font-size: calc(11px * var(--text-scale, 1));border:1px solid var(--border);border-radius:6px;padding:3px 5px;background:var(--bg-input);color:var(--text-primary);";
  ...
  lineLabelInp.style.cssText = "width:90px;font-size: calc(11px * var(--text-scale, 1));border:1px solid var(--border);border-radius:6px;padding:3px 5px;background:var(--bg-input);color:var(--text-primary);";
  ...
  lineLabelFlipBtn.style.cssText = "padding:4px 10px;font-size: calc(11px * var(--text-scale, 1));cursor:pointer;border:1px solid var(--border);border-radius:6px;background:var(--bg-input);color:var(--text-primary);";
  ...
  function makeDashSliderRow(labelText, prop) {
    ...
    num.max = "1.5";
    num.step = "0.1";
    num.style.cssText = "width:40px;font-size: calc(11px * var(--text-scale, 1));border:1px solid var(--border);border-radius:6px;padding:2px 4px;text-align:center;background:var(--bg-input);color:var(--text-primary);";
  ...
  ratioNum.max = "1";
  ratioNum.step = "0.05";
  ratioNum.style.cssText = "width:40px;font-size: calc(11px * var(--text-scale, 1));border:1px solid var(--border);border-radius:6px;padding:2px 4px;text-align:center;background:var(--bg-input);color:var(--text-primary);";
  ...
  flipBtn.style.cssText = "padding:4px 10px;font-size: calc(11px * var(--text-scale, 1));cursor:pointer;border:1px solid var(--border);border-radius:6px;background:var(--bg-input);color:var(--text-primary);";
