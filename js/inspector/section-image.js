...
import { startRectErase, startPathErase, clearCutouts, cancelImageEditSession } from "../image-cutout.js?v=0.54.8";
import { makeSection } from "./widgets.js?v=0.54.8";
import { startImageCompare } from "../image-compare.js?v=0.54.8";
...
export function buildImageSection(ctx) {
  ...
  imgRectEraseBtn.onclick = async () => {
    const mod = await import("../image-cutout.js?v=0.54.8");
    mod.startRectErase();
  };
