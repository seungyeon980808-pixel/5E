...
import { startRectErase, startPathErase, clearCutouts, cancelImageEditSession } from "../image-cutout.js?v=0.55.0";
import { makeSection } from "./widgets.js?v=0.55.0";
import { startImageCompare } from "../image-compare.js?v=0.55.0";
...
export function buildImageSection(ctx) {
  ...
  imgRectEraseBtn.onclick = async () => {
    const mod = await import("../image-cutout.js?v=0.55.0");
    mod.startRectErase();
  };
