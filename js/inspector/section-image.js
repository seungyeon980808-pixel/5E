...
import { startRectErase, startPathErase, clearCutouts, cancelImageEditSession } from "../image-cutout.js?v=0.44.4";
import { makeSection } from "./widgets.js?v=0.44.4";
...
export function buildImageSection(ctx) {
  ...
  imgRectEraseBtn.onclick = async () => {
    const mod = await import("../image-cutout.js?v=0.44.4");
    mod.startRectErase();
  };
