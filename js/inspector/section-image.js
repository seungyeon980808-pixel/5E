...
import { startRectErase, startPathErase, clearCutouts, cancelImageEditSession } from "../image-cutout.js?v=0.46.0";
import { makeSection } from "./widgets.js?v=0.46.0";
...
export function buildImageSection(ctx) {
  ...
  imgRectEraseBtn.onclick = async () => {
    const mod = await import("../image-cutout.js?v=0.46.0");
    mod.startRectErase();
  };
