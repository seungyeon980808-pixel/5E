...
export function buildCoordplaneSection(ctx) {
  ...
  editBtn.style.cssText = "width:100%;margin-bottom:8px;font-size: calc(12px * var(--text-scale, 1));padding:6px;border:1px solid var(--accent);border-radius:6px;background:color-mix(in srgb, var(--accent) 22%, var(--bg-input));color:var(--text-primary);cursor:pointer;";
