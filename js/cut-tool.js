...
import { cutObject, isCuttable, distanceToObject } from "./cut-geometry.js?v=0.48.4";
import { snapLineEnd } from "./geometry.js?v=0.48.4";
import { getObjectBBox } from "./pick.js?v=0.48.4";
