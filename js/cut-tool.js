...
import { cutObject, isCuttable, cutCrossingPoints } from "./cut-geometry.js?v=0.54.9";
import { snapLineEnd } from "./geometry.js?v=0.54.9";
import { simplifyRDP } from "./geometry.js?v=0.54.9";
