...
import { cutObject, isCuttable, cutCrossingPoints } from "./cut-geometry.js?v=0.54.5";
import { snapLineEnd } from "./geometry.js?v=0.54.5";
import { simplifyRDP } from "./geometry.js?v=0.54.5";
import { getObjectBBox } from "./pick.js?v=0.54.5";
