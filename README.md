...
| [④ 과목별 오브젝트](#-과목별-오브젝트) | 역학 · 전기자기학 · 파동 · 열 · 현대물리 |
...
모든 선은 **선 종류(실선·파선·점선)·굵기·색**을 따로 주고, 나중에 앵커를 옮겨 고칠 수 있습니다.
...
과목을 고르면 팔레트가 통째로 바뀝니다. 그리지 않고 **끌어다 놓는** 부품들입니다.

| 분류 | 들어 있는 것 |
|---|---|
| **역학** | 클램프 · 저울 · 도르래 · 역학 수레 · 단진자 · 받침대 · 회전축 · 막대자석 |
| **전기자기학** | 도선 · 나침반 · 저항 · 코일 · 축전기 · 직류전원 · 교류전원 · 전구 · 전류계 · 전압계 · 다이오드 |
| **파동 및 광학** | 렌즈 · 거울 · 광원 · 파면 등 |
| **열역학** | 실린더 · 피스톤 · 열원 등 |
| **현대물리학** | 원자 모형 · 에너지 준위 등 |

화학·생명·지구과학도 각각의 팔레트를 가집니다. 부품은 벡터라 크기를 바꿔도 깨지지 않고, 선 굵기·색을 그림 전체와 맞출 수 있습니다.
