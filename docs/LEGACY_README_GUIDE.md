...
> 기존 README의 상세 기능 설명을 보존한 문서입니다. 현재 배포판과 알려진 제한은 [프로젝트 첫 화면](../README.md)을 먼저 확인하세요. 아래 버전 이력은 과거 기록이며 최신판 안내가 아닙니다.
...
<p><a href="https://github.com/seungyeon980808-pixel/5E/releases/tag/v1.5.0">과거 릴리즈 <strong>v1.5.0</strong> — 무엇이 바뀌었나</a></p>
<p><a href="RELEASE_NOTES_v1.5.0.html"><strong>v1.5.0 릴리즈 노트</strong> — 전체 변경 보기</a></p>
...
- **Windows 배포** — 설치 파일은 GitHub Releases에서 제공하며 [코드 서명 정책](CODE_SIGNING_POLICY.md)을 공개합니다.
...
<img src="images/release-v1.0.0/01-workspace.png" alt="5E 화면 구성 — 상단 툴바, 좌 오브젝트 패널, 가운데 캔버스, 우 속성 패널, 하단 페이지 탭" width="820" />
...
<img src="images/release-v1.0.0/02-exam-library.png" alt="과목 칩과 4열 카드 그리드로 된 기출 문항 검색" width="820" />
...
<img src="images/release-v1.1.0/03-refwin.png" alt="작업 화면과 별도 창으로 띄운 참고 문항" width="820" />
...
<img src="images/release-v1.2.0/10-axis-detail.png" alt="비대칭 좌표축과 네 끝 여백 지정" width="820" />
...
<img src="images/readme/14-tick-labels.png" alt="눈금 라벨 네 가지 방식 비교" width="820" />
...
<img src="images/release-v1.1.0/02-range.png" alt="사각형을 끌어 정의역과 치역을 한 번에 지정" width="820" />

- **정의역·치역** — 값으로 입력하거나, 미리보기 위에 **사각형을 끌어 한 번에** 잡습니다. 그래프의 일부만 보여주는 문항에 씁니다
- **여러 함수** — 한 평면에 겹쳐 넣고, 선 종류(실선·파선·점선)와 굵기를 따로 줍니다
- **끝 라벨** — 곡선 끝에 이름을 붙입니다

<img src="images/release-v1.1.0/01-bezier.png" alt="자유곡선을 그린 뒤 앵커와 베지어 핸들로 다듬는 과정" width="820" />
...
<img src="images/release-v1.2.0/02-annot-after.png" alt="빈 좌표평면에 표시점·수선의 발·안내 점선·범례를 올린 모습" width="620" />
...
<img src="images/release-v1.2.0/04-labelpt-after.png" alt="점 주위를 15도씩 도는 이름표" width="520" />
...
<img src="images/release-v1.2.0/07-arrowhead-after.png" alt="뒤쪽이 오목한 평가원 스타일 화살촉" width="360" />
...
<img src="images/readme/01-lines.png" alt="직선·꺾은선·곡선·자유 그리기 네 가지 비교" width="820" />
...
<img src="images/readme/02-stroke.png" alt="선 종류(실선·파선·점선)와 굵기 단계, 화살촉과 치수선" width="820" />

### 도형

타원 <kbd>O</kbd> · 사각형 <kbd>S</kbd> · 직각삼각형 <kbd>Y</kbd>. 채움과 테두리를 따로 정합니다.

<img src="images/readme/03-shapes.png" alt="타원·사각형·직각삼각형과 채움/테두리 조합" width="820" />
...
<img src="images/readme/04-labeler.png" alt="지시선과 이름표가 대상을 따라 움직이는 라벨러" width="820" />

라벨러는 **지시선과 이름표가 한 몸**입니다. 대상을 옮기면 함께 따라오므로, 나중에 배치를 바꿔도 선을 다시 긋지 않습니다. 이름표 자리에는 수식도 들어갑니다.

<img src="images/readme/05-formula.png" alt="LaTeX 수식 예시와 시험지 기호 팔레트" width="820" />

<img src="images/release-v1.2.0/13-text-spacing.png" alt="자간과 장평을 다르게 준 같은 문장" width="820" />
...
<img src="images/readme/06-measure.png" alt="각도 호·직각 표시·점·치수선" width="820" />

<img src="images/readme/07-gauge.png" alt="그림 위에 올려놓고 재는 자와 각도기" width="820" />
...
<img src="images/readme/08-cut.png" alt="채움이 있는 도형을 곡선으로 잘라 둘로 나누는 과정" width="820" />
...
<img src="images/readme/09-subject-objects.png" alt="역학·전기자기학·파동 및 광학 부품 팔레트" width="820" />
...
<img src="images/readme/10-objectify.png" alt="스캔 이미지를 벡터 조각으로 바꾸는 과정과 인식 옵션" width="820" />
...
<img src="images/readme/11-compare.png" alt="원본 비교와 인쇄 비교 배경" width="820" />
...
<img src="images/readme/12-snap.png" alt="끝점·중점·교점 스냅과 기울어진 면에 회전해 붙는 스냅" width="820" />

<img src="images/readme/13-bulk.png" alt="속성 복사와 전체 통일/수정" width="820" />

---

## ⑦ 페이지와 내보내기

<img src="images/release-v1.0.0/03-pages.png" alt="문항마다 페이지 하나, 폴더에 일괄 내보내기" width="820" />
...
<img src="images/release-v1.2.0/12-export-after.png" alt="폴더 연결, 페이지 선택, 이름 그대로 저장" width="620" />
...
<img src="images/release-v1.1.0/04-backup.png" alt="localStorage 5MB 상한과 IndexedDB 비교" width="820" />

---

## ⑨ 화면과 환경

<img src="images/release-v1.0.0/05-prolite.png" alt="Lite 모드와 Pro 모드 비교" width="820" />
...
<img src="images/release-v1.0.0/04-palette.png" alt="Ctrl+K 커맨드 팔레트" width="820" />
...
| 판 | 무엇이 들어갔나 |
|---|---|
| [**v1.5.0**](RELEASE_NOTES_v1.5.0.html) | 이미지 작업대 · 다중 참고 이미지와 영역 요청 · 분리형 자르기 · 드래그 아트보드 · 투명 배경 · Windows 설치판 · `.5e` 프로젝트 · 평가원 도식 Engine V2 |
