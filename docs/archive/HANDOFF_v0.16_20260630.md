> ⚠️ **보관용 문서 (2026-06-30, v0.16 시점)**
>
> 이 문서의 버전·완료 목록·파일 구조는 현재와 다르다. 세션 인계와 현재 상태는
> 저장소 루트의 `CLAUDE.md`, 폴더·브랜치 지도는 `docs/BRANCH_MAP.md`를 볼 것.
> 여기 남긴 이유는 초기 설계 의도와 당시 판단 근거를 잃지 않기 위해서다.
